...
function draw() {
  ...
  */
  ...
  if (tokenState.animateThis === true) {
    tokenState.divXSlide = sin(animCounter / tokenState.animSpeed) * 100;
    tokenState.flattenAng = sin(animCounter / tokenState.animSpeed) * 100;
  }
